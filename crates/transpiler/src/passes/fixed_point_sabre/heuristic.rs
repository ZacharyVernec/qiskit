...
//
// Copy of ../sabre/heuristic.rs further modified by Zachary Vernec
...
#[pyclass]
#[pyo3(module = "qiskit._accelerate.fixed_point_sabre", frozen, eq)]
...
#[pyclass]
#[pyo3(module = "qiskit._accelerate.fixed_point_sabre", frozen)]
