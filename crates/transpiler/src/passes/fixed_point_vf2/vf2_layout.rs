...
#[pyclass(name = "VF2PassConfiguration")] // same python class name, but don't collide on the internal Rust struct name
#[derive(Clone, Debug)]
...
#[pyclass(name = "VF2PassReturn")] // same python class name, but don't collide on the internal Rust struct name
